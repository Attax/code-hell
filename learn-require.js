...
(function(global, setTimeout) {
    ...
    /** 
     * 检测传入的参数类型是否为函数
     * ostring方法为Object.prototype.toString()
     */
    ...
    function each(ary, func) {
        ...
        if (ary) {
            ...
            for (i = 0; i < ary.length; i += 1) {
                //如果数组的值为true，向回调函数里注入value(ary[i])和ary,执行回调函数，并且回调函数返回true，跳出循环
    ...
    function hasProp(obj, prop) {
        //obj调用Object.prototype.hasOwnProperty方法，判断是否具有prop属性
    ...
    function eachProp(obj, func) {
        ...
        for (prop in obj) {
            //如果obj对象上有prop属性
            if (hasProp(obj, prop)) {
                //向回调函数注入obj对象的属性值value (obj[prop])、对象本身，如果回调函数返回值，跳出循环
	...
	*/
    ...
    /**
     * 如果其他AMD加载器已经定义过define，不要再次定义define
     */
